...
@section('content')
    ...
    <div class="w-full mt-14">
        ...
        {{-- tab schedule --}}
        <div id="schedule">
            <div class="block p-4 rounded-lg  " id="regular" role="tabpanel" aria-labelledby="regular-tab">
                {{-- headeing --}}
                <div class="mb-4 border-b  border-gray-900">
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-white" id="schedule1-styled-tab"
                        data-tabs-toggle="#schedule1"
                        data-tabs-active-classes="hover:text-red-700 text-red-600 border-red-500"
                        role="tablist">
                        @for ($i = 1; $i <= $day; $i++)
                            <li class="me-2" role="presentation">
                                <button class="inline-block p-4 border-b-2 rounded-t-lg" aria-activedescendant="day{{ $i }}" id="regular-styled-tab"
                    ...
                    @for ($i = 1; $i <= $day; $i++)
                        <div class="p-4 rounded-lg   w-full flex flex-wrap flex-col md:flex-row justify-center items-center gap-2"
                            ...
                            @foreach ($schedules as $item)
                                @if ($i == $item->day)
                                    <div class="w-full md:max-w-[320px] flex flex-col border-gray-700 bg-gray-900 shadow-xl shadow-gray-800/100 rounded-xl border-2 py-2 md:py-4">
        ...
        <div class="mb-4 border-b  border-gray-700">
            ...
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center " id="standing-styled-tab"
                ...
                @foreach ($grup as $item)
                    <li class="me-2" role="presentation">
                        <button class="inline-block p-4 md:p-6 border-b-2 rounded-t-lg" id="regular-styled-tab"
